...
namespace GriffinPlus.Lib
{
	...
	{
		/// <summary>
		/// Creates instances of the specified type using a constructor with 3 parameters
		...
		private static class Creator<TArg1, TArg2, TArg3>
		{
			...
			public static T CreateInstance(TArg1 arg1, TArg2 arg2, TArg3 arg3)
			{
				Func<TArg1, TArg2, TArg3, T> creator = sCreator ?? InitCreator();
				return creator(arg1, arg2, arg3);
			}

			/// <summary>
			/// Crafts a creator delegate that creates an instance of <typeparamref name="T"/> using its
			/// constructor with the parameters specified by <typeparamref name="TArg1"/> to <typeparamref name="TArg3"/>.
			/// </summary>
			/// <returns>The creator delegate.</returns>
			private static Func<TArg1, TArg2, TArg3, T> InitCreator()
			{
				...
				lock (sInitSync)
				{
					...
					Func<TArg1, TArg2, TArg3, T> creator = MakeCreator();
			...
			/// constructor defined by <typeparamref name="TArg1"/> to <typeparamref name="TArg3"/>.
			/// </summary>
			/// <returns>The creator delegate.</returns>
			private static Func<TArg1, TArg2, TArg3, T> MakeCreator()
			{
				...
				return (Func<TArg1, TArg2, TArg3, T>)Expression.Lambda(
						typeof(Func<TArg1, TArg2, TArg3, T>),
