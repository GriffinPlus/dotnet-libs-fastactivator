...
namespace GriffinPlus.Lib
{
	...
	{
		/// <summary>
		/// Creates instances of the specified type using a constructor with 8 parameters
		...
		private static class Creator<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8>
		{
			private static readonly object                                                          sInitSync = new object();
			private static          Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, T> sCreator  = null;

			/// <summary>
			/// Creates an instance of <typeparamref name="T"/> using its constructor with parameters specified by <typeparamref name="TArg1"/> to
			/// <typeparamref name="TArg8"/>.
			/// </summary>
			...
			public static T CreateInstance(
				...
				TArg8 arg8)
			{
				Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, T> creator = sCreator ?? InitCreator();
				return creator(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
			}

			/// <summary>
			/// Crafts a creator delegate that creates an instance of <typeparamref name="T"/> using its
			/// constructor with the parameters specified by <typeparamref name="TArg1"/> to <typeparamref name="TArg8"/>.
			/// </summary>
			/// <returns>The creator delegate.</returns>
			private static Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, T> InitCreator()
			{
				...
				lock (sInitSync)
				{
					...
					Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, T> creator = MakeCreator();
			...
			/// constructor defined by <typeparamref name="TArg1"/> to <typeparamref name="TArg8"/>.
			/// </summary>
			/// <returns>The creator delegate.</returns>
			private static Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, T> MakeCreator()
			{
				// prepare list of constructor parameter types
				Type[] parameterTypes =
				{
					typeof(TArg1), typeof(TArg2), typeof(TArg3), typeof(TArg4), typeof(TArg5),
					typeof(TArg6), typeof(TArg7), typeof(TArg8)
				};
				...
				return (Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, T>)Expression.Lambda(
						typeof(Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, T>),
