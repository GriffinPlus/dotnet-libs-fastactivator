...
namespace GriffinPlus.Lib
{
	...
	{
		/// <summary>
		/// Creates instances of the specified type using a constructor with 10 parameters
		...
		private static class Creator<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TArg10>
		{
			private static readonly object                                                                         sInitSync = new object();
			private static          Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TArg10, T> sCreator  = null;

			/// <summary>
			/// Creates an instance of <typeparamref name="T"/> using its constructor with parameters specified by <typeparamref name="TArg1"/> to
			/// <typeparamref name="TArg10"/>.
			/// </summary>
			...
			/// constructor with the parameters specified by <typeparamref name="TArg1"/> to <typeparamref name="TArg10"/>.
			/// </summary>
			/// <returns>The creator delegate.</returns>
			private static Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TArg10, T> InitCreator()
			{
			...
			/// constructor defined by <typeparamref name="TArg1"/> to <typeparamref name="TArg10"/>.
			/// </summary>
			/// <returns>The creator delegate.</returns>
			private static Func<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TArg8, TArg9, TArg10, T> MakeCreator()
			{
