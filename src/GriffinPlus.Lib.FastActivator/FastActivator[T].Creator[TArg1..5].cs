...
namespace GriffinPlus.Lib
{
	...
	{
		/// <summary>
		/// Creates instances of the specified type using a constructor with 5 parameters
		...
		private static class Creator<TArg1, TArg2, TArg3, TArg4, TArg5>
		{
			...
			public static T CreateInstance(
				...
				TArg5 arg5)
			{
				Func<TArg1, TArg2, TArg3, TArg4, TArg5, T> creator = sCreator ?? InitCreator();
			...
			/// constructor with the parameters specified by <typeparamref name="TArg1"/> to <typeparamref name="TArg5"/>.
			/// </summary>
			/// <returns>The creator delegate.</returns>
			private static Func<TArg1, TArg2, TArg3, TArg4, TArg5, T> InitCreator()
			{
				...
				lock (sInitSync)
				{
					...
					Func<TArg1, TArg2, TArg3, TArg4, TArg5, T> creator = MakeCreator();
			...
			/// constructor defined by <typeparamref name="TArg1"/> to <typeparamref name="TArg5"/>.
			/// </summary>
			/// <returns>The creator delegate.</returns>
			private static Func<TArg1, TArg2, TArg3, TArg4, TArg5, T> MakeCreator()
			{
				...
				return (Func<TArg1, TArg2, TArg3, TArg4, TArg5, T>)Expression.Lambda(
						typeof(Func<TArg1, TArg2, TArg3, TArg4, TArg5, T>),
